...
setMethod("dbGetRowsAffected", "ODBCResult", function(res, ...) {
  1
  #Default as 1. This is not correct.
  #Need to modify the RODBCGetInfo method in RODBC.c so that the affected rows can be fetched. Currently it does not fetch this.
})
